...
/**
 * Mortgage Account Response DTO for Officer APIs
 * Maps với response từ /api/mortgage/* endpoints
 */
public class MortgageAccountResponse {
    ...
    private String status; // PENDING_APPRAISAL, APPROVED, ACTIVE, COMPLETED, REJECTED
